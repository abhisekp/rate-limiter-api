(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("RateLimiterApi", [], factory);
	else if(typeof exports === 'object')
		exports["RateLimiterApi"] = factory();
	else
		root["RateLimiterApi"] = factory();
})(this, function() {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__baseRest_js__ = __webpack_require__(326);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__toInteger_js__ = __webpack_require__(331);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__internal_queue__ = __webpack_require__(141);
 ...
 * });
 */
/* harmony default export */ exports["a"] = function (worker, concurrency) {
    return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__internal_queue__["a" /* default */])(function (items, cb) {
        worker(items[0], cb);
    }, concurrency, 1);
};
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__isObject_js__ = __webpack_require__(328);
...
function isFunction(value) {
  ...
  var tag = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__isObject_js__["a" /* default */])(value) ? objectToString.call(value) : '';
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__isObjectLike_js__ = __webpack_require__(329);
...
function isNumber(value) {
  return typeof value == 'number' ||
    (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__isObjectLike_js__["a" /* default */])(value) && objectToString.call(value) == numberTag);
}
...
var _lodashCollectionForEach = __webpack_require__(332);

var _lodashCollectionForEach2 = _interopRequireDefault(_lodashCollectionForEach);

var _lodashLangIsFunction = __webpack_require__(131);

var _lodashLangIsFunction2 = _interopRequireDefault(_lodashLangIsFunction);

var _lodashLangIsObject = __webpack_require__(40);

var _lodashLangIsObject2 = _interopRequireDefault(_lodashLangIsObject);

var _supermixer = __webpack_require__(356);
...
"use strict";
/* harmony export */ exports["a"] = DLL;// Simple doubly linked list (https://en.wikipedia.org/wiki/Doubly_linked_list) implementation
...
"use strict";
/* harmony export */ exports["a"] = onlyOnce;function onlyOnce(fn) {
    return function() {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_es_arrayEach__ = __webpack_require__(325);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash_es_isArray__ = __webpack_require__(327);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_lodash_es_noop__ = __webpack_require__(330);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_lodash_es_rest__ = __webpack_require__(122);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__onlyOnce__ = __webpack_require__(140);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__setImmediate__ = __webpack_require__(142);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__DoublyLinkedList__ = __webpack_require__(139);
/* harmony export */ exports["a"] = queue;
...
function queue(worker, concurrency, payload) {
    ...
    function _insert(data, insertAtFront, callback) {
        ...
        q.started = true;
        if (!__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_lodash_es_isArray__["a" /* default */])(data)) {
            data = [data];
        }
        if(data.length === 0 && q.idle()) {
            // call drain immediately if there are no tasks
            return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5__setImmediate__["a" /* default */])(function() {
                q.drain();
            });
        }
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_lodash_es_arrayEach__["a" /* default */])(data, function(task) {
            var item = {
                data: task,
                callback: callback || __WEBPACK_IMPORTED_MODULE_2_lodash_es_noop__["a" /* default */]
            };
        ...
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5__setImmediate__["a" /* default */])(q.process);
    }

    function _next(tasks) {
        return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3_lodash_es_rest__["a" /* default */])(function(args){
            workers -= 1;

            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_lodash_es_arrayEach__["a" /* default */])(tasks, function (task) {
                __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_lodash_es_arrayEach__["a" /* default */])(workersList, function (worker, index) {
                    if (worker === task) {
    ...
    var workersList = [];
    var q = {
        _tasks: new __WEBPACK_IMPORTED_MODULE_6__DoublyLinkedList__["a" /* default */](),
        concurrency: concurrency,
        payload: payload,
        saturated: __WEBPACK_IMPORTED_MODULE_2_lodash_es_noop__["a" /* default */],
        unsaturated:__WEBPACK_IMPORTED_MODULE_2_lodash_es_noop__["a" /* default */],
        buffer: concurrency / 4,
        empty: __WEBPACK_IMPORTED_MODULE_2_lodash_es_noop__["a" /* default */],
        drain: __WEBPACK_IMPORTED_MODULE_2_lodash_es_noop__["a" /* default */],
        error: __WEBPACK_IMPORTED_MODULE_2_lodash_es_noop__["a" /* default */],
        started: false,
        paused: false,
        ...
        kill: function () {
            q.drain = __WEBPACK_IMPORTED_MODULE_2_lodash_es_noop__["a" /* default */];
            q._tasks.empty();
        },
        ...
        process: function () {
            while(!q.paused && workers < q.concurrency && q._tasks.length){
                ...
                var cb = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__onlyOnce__["a" /* default */])(_next(tasks));
                worker(data, cb);
            }
        },
        length: function () {
...
"use strict";
/* WEBPACK VAR INJECTION */(function(setImmediate, process) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_es_rest__ = __webpack_require__(122);
/* unused harmony export hasSetImmediate *//* unused harmony export hasNextTick *//* unused harmony export fallback *//* unused harmony export wrap */'use strict';
...
function wrap(defer) {
    return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_lodash_es_rest__["a" /* default */])(function (fn, args) {
        defer(function () {
            fn.apply(null, args);
        });
    });
...
/* harmony default export */ exports["a"] = wrap(_defer);

/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(92).setImmediate, __webpack_require__(91)))
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__apply_js__ = __webpack_require__(324);
...
var arrayEach = __webpack_require__(123),
    baseEach = __webpack_require__(337),
    createForEach = __webpack_require__(342);
...
var arrayCopy = __webpack_require__(333),
...
var bufferClone = __webpack_require__(339);
...
var baseFor = __webpack_require__(124),
    createForIn = __webpack_require__(343);
...
var baseForOwn = __webpack_require__(89),
    createForOwn = __webpack_require__(344);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(93), __webpack_require__(91)))
...
var _mixer = __webpack_require__(357);
...
var _lodashObjectForOwn = __webpack_require__(353);

var _lodashObjectForOwn2 = _interopRequireDefault(_lodashObjectForOwn);

var _lodashObjectForIn = __webpack_require__(352);

var _lodashObjectForIn2 = _interopRequireDefault(_lodashObjectForIn);

var _lodashLangCloneDeep = __webpack_require__(349);
...
var _lodashLangIsUndefined = __webpack_require__(351);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_stampit__ = __webpack_require__(138);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_stampit___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_stampit__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_async_es_queue__ = __webpack_require__(134);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_lodash_es_isNumber__ = __webpack_require__(137);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_lodash_es_isFunction__ = __webpack_require__(136);
 ...
 * whichever is lower.
 */
const RateLimiter = __WEBPACK_IMPORTED_MODULE_1_stampit___default()().refs({
  ...
  */
	this.updateRateLimits = function ({
		...
		if (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3_lodash_es_isNumber__["a" /* default */])(Number(rateLimit))) {
			rateLimits.rateLimit = Number(rateLimit);
		}

		if (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3_lodash_es_isNumber__["a" /* default */])(Number(rateRemaining))) {
			rateLimits.rateRemaining = Number(rateRemaining);
		}

		if (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3_lodash_es_isNumber__["a" /* default */])(Number(rateReset))) {
	...
	const q = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2_async_es_queue__["a" /* default */])((requestHandler, responseHandler) => {
		if (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4_lodash_es_isFunction__["a" /* default */])(requestHandler)) {
...
/* harmony default export */ exports["default"] = RateLimiter;
